...
SECRET_KEY = "django-insecure-!^j^!q#shu18axfi)hk9+wuo)a-o6oy3b5^v6+l6s_vp119ci-"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS: list = ["localhost", "notification-app"]
...
LOGGING = {
    ...
    "handlers": {
        ...
        "notification_error_file": {
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOG_DIR / "notification-error.logs",
            "formatter": "verbose",
            "maxBytes": 5_000_000,
            "backupCount": 5,
        },
    ...
    "loggers": {
        ...
        "notification": {
            "handlers": ["console", "notification_error_file"],
            "level": "INFO",
            "propagate": False,
        },
        "mysql": {

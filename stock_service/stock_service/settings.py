...
SECRET_KEY = "django-insecure-vag8+s8o(0o376mor7#l6!db6q6r0l^d^n50c8$pwcl0spi1!@"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS: list = ["localhost", "stock-app"]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "stock": {
            "handlers": ["console", "stock_error_file"],
            "level": "INFO",
            "propagate": False,
        },
        "mysql": {
